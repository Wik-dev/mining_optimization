...
| **AI Reasoning Layer** (SafeClaw) | Read ML outputs via SafeClaw `fleet_status_query` + market context, propose specific device commands with natural-language rationale          | Contextual reasoning. Proposes actions but cannot execute them. |
